...
// @endregion// @endlock
	...
	// NOTICE : istarting with version 2, we'll be able to (better) call
	// the enable() or disable() functions of the widget instead of using jQuery
	// $$('button1').disable(à;
...
// eventHandlers// @lock
	...
	{// @endlock
		if (WAF.directory.currentUser() != null) {
			if(WAF.sources.toDoList.complete) {

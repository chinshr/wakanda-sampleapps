...
// eventHandlers// @lock
	...
	{// @endlock
		//$('#textField8').val(myCurrentDate);
		if (WAF.sources.pTO_Request.authorized) {
			WAF.sources.pTO_Request.authorizationDate = new Date();
		} else {
			WAF.sources.pTO_Request.authorizationDate = null;
		}
